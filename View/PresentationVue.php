<?php
    ...
    class PresentationVue extends CommonView
    {
        ...
        public function presentation(){
            ...
            echo "<div class='presentation'>
                        ...
                        <img  width='70%' src='".(substr_count($this->presentation['ImageLink'],$_SESSION['imageFolder'])?"/?view=HomePage&action=viewImage&link=".basename($this->presentation['ImageLink']):$this->presentation['ImageLink'])."'>
